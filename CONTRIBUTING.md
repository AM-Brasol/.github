...
> **Replicado de [`brasol-solucoes/CONTRIBUTING.md`](https://github.com/brasol-solucoes/.github/blob/main/CONTRIBUTING.md).**
> Mesma convenção nas duas orgs da Brasol (`brasol-solucoes` e `AM-Brasol`) — essa continua sendo a fonte
> canônica; em caso de conflito futuro entre as duas cópias, ela vence.
