...
> Replicado de [`brasol-solucoes/docs/ai-observability.md`](https://github.com/brasol-solucoes/.github/blob/main/docs/ai-observability.md) — a política vale para **toda** IA operando em nome da Brasol, nas duas orgs (`brasol-solucoes` e `AM-Brasol`). O serviço auditor (**Pára-Raios**) e o schema canônico do evento vivem em `brasol-solucoes/svc-para-raios-agent-auditor` — não há cópia própria em `AM-Brasol`.
