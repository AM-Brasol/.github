...
> Replicado de [`brasol-solucoes/docs/onboarding.md`](https://github.com/brasol-solucoes/.github/blob/main/docs/onboarding.md) — mesmo fluxo nas duas orgs da Brasol.
