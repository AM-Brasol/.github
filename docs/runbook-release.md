...
> Replicado de [`brasol-solucoes/docs/runbook-release.md`](https://github.com/brasol-solucoes/.github/blob/main/docs/runbook-release.md) — mesmo procedimento nas duas orgs da Brasol.
