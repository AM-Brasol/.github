...
> Replicado de [`brasol-solucoes/docs/runbook-ai-logging.md`](https://github.com/brasol-solucoes/.github/blob/main/docs/runbook-ai-logging.md) — mesmo procedimento nas duas orgs da Brasol; o Pára-Raios (auditor) fica em `brasol-solucoes/svc-para-raios-agent-auditor`.
